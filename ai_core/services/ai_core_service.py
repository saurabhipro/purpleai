...
def _get_ai_settings(env):
    ...
    settings = {
        ...
        'mistral_api_key': config.get_param('ai_core.mistral_api_key', ''),
        'mistral_model': config.get_param('ai_core.mistral_model', 'mistral-document-ai-2505'),
        'mistral_endpoint_url': config.get_param('ai_core.mistral_endpoint_url', ''),
        'mistral_verify_ssl': config.get_param('ai_core.mistral_verify_ssl', 'true'),
